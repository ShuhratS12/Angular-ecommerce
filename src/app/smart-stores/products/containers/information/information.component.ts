...
@Component({
  ...
  styleUrls: ['./information.component.scss', '../products/products.component.scss']
})
export class InformationComponent implements OnInit, OnDestroy {
  ...
  loadOptions(): void {
    this.store.dispatch(new fromProducts.LoadTags(this.tagType.Information));
  }
  ...
  async insert()
  {
    let categoryDetailLink = '/products/informations/'+ 0;
